...
Task("Build")
    .Does(context => 
{
    DotNetCoreBuild("./src/Autograph.sln", new DotNetCoreBuildSettings {
...
Task("Test")
    ...
    .Does(context => 
{
    DotNetCoreTest("./src/Autograph.sln", new DotNetCoreTestSettings {
        Configuration = configuration,
        NoRestore = true,
        NoBuild = true,
    });
    ...
    .Does(context => 
{
    ...
    context.DotNetCorePack($"./src/Autograph.sln", new DotNetCorePackSettings {
        Configuration = configuration,
        NoRestore = true,
        NoBuild = true,
